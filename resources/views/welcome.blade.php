        ...
        <nav class="navbar navbar-custom" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header img-responsive">
                    <button type="button" class="navbar-toggle" style="margin-right:0; color:#fff; padding:0;" data-toggle="collapse" data-target=".navbar-main-collapse">
                    ...
                    <!-- <a class=" page-scroll" href="#page-top">
                            <img src="images/lo.png" class="img img-responsive" alt="" style="width:10rem" />
                        </a> -->
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li >
                            <a href="#page-top">Thank A Soldier</a>
                        </li>
                        <li>
                            <a href="#">Gratitude Wall</a>
                        </li>
                        <li>
                            <a href="#">About The Campaign</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
